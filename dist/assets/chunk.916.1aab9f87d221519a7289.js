/*! For license information please see chunk.916.1aab9f87d221519a7289.js.LICENSE.txt */
...
s.placeholder=n,s.title="Type to search through and reduce the list.",f.disabled=!o.isDirty(),p.style.display=o.selectedMap.size?"":"none"}return E.id="qunit-modulefilter",E.appendChild(a),E.appendChild(v.createTextNode(" ")),E.appendChild(u),d(E,"submit",M),d(E,"reset",(function(){o.selectedMap=new k(n),S(),C()})),E}(t)),v.createElement("div").className="clearfix",c.appendChild(f),c.appendChild(v.createElement("div"))}}(t)}(t)})),Ge.on("runEnd",(function(t){var n,r,i,o=T("qunit-banner"),s=T("qunit-tests"),a=T("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",t.runtime," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",_(et.failedTests)].join("")
